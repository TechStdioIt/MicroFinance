        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmsGatewayEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    SmsGatewayApiKey = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    SignatureUrl = table.Column<string>(type: "text", nullable: false),
                    FingerprintEnrolled = table.Column<bool>(type: "boolean", nullable: false),
                    NomineeName = table.Column<string>(type: "text", nullable: false),
                    NomineeRelationship = table.Column<string>(type: "text", nullable: false),
                    NomineeNidNumber = table.Column<string>(type: "text", nullable: false),
                    NomineePhone = table.Column<string>(type: "text", nullable: false),
                    NomineeSharePercentage = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedMaturityAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    MaturityDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LatePenaltyAccrued = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    NextDueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DpsAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DpsAccounts_Members_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRepayable = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ...
                    NextEmiDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DisbursementsDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FingerprintVerified = table.Column<bool>(type: "boolean", nullable: false),
